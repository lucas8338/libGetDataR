...
Rcpp_math_mean <- function(data) {
    .Call('_libGetDataR_Rcpp_math_mean', PACKAGE = 'libGetDataR', data)
}

Rcpp_math_standardDeviation <- function(data) {
    .Call('_libGetDataR_Rcpp_math_standardDeviation', PACKAGE = 'libGetDataR', data)
}
